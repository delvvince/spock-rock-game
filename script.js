...
// Add 'selected' styling and display computerChoice text
...
// Check result, increase scores and update resultText
function updateScore(playerChoice) {
  ...
  if (playerChoice === computerChoice) {
    ...
    if (choice.defeats.indexOf(computerChoice) > -1) {
      // Dynamic imports - Chrome only alternative
      // import('./confetti.js')
      //   .then((module) => {
...
function select(playerChoice) {
  ...
  // Add 'selected' styling and playerChoice text
  switch(playerChoice) {
    case 'rock':
